...
export const ORDER_READY_RESET = 'ORDER_READY_RESET'

export const ORDER_GET_READY_REQUEST = 'ORDER_GET_READY_REQUEST'
export const ORDER_GET_READY_SUCCESS = 'ORDER_GET_READY_SUCCESS'
export const ORDER_GET_READY_FAIL = 'ORDER_GET_READY_FAIL'
export const ORDER_GET_READY_RESET = 'ORDER_GET_READY_RESET'